...
4. After scanning the archive, Eclipse lists the following projects under ‘Projects’ selection box:
	...
	- CoffeeVendingMachineApp
	- CoffeeVendingMachineIfce
...
4. There in the 'Program Arguments' text box ,write 'coffeecomp.CoffeeVendingMachineApp'.This is the name of the main file of the application you want to execute.
...
8. Use the Coffee Vending Machine program as guided by the text based menu.
